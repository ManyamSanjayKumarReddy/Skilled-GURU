...
export default function UpcomingFeatures() {
  return (
    <section id="mock-interviews" className="py-16 md:py-20 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        <div className="relative bg-white bg-opacity-40 backdrop-filter backdrop-blur-lg rounded-3xl p-6 md:p-8 lg:p-12 shadow-xl">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-4 md:p-6 rounded-xl transition-all duration-300 hover:shadow-lg hover:bg-white hover:bg-opacity-50"
              >
          ...
          <div className="absolute inset-0 grid grid-cols-1 md:grid-cols-2 pointer-events-none">
            <div className="border-b md:border-r md:border-b border-gray-400 border-dashed"></div>
